...
setupSignatureCanvas("clientSig", false);
  ...
  { id: "2.2.2.2", desc: "Mat Installation and Removal" },
  { id: "2.2.2.3", desc: "Mat Usage" },
  { id: "2.2.2.4", desc: "Additional Trucking Distance (Pickup)" },
  { id: "2.2.2.5", desc: "Additional Trucking Distance (Semi-truck and trailer)" },
  { id: "2.2.3.1", desc: "Third Party Sweep" },
  { id: "2.2.4.2", desc: "Hydrovac Material Removed – Cold" },
  { id: "2.2.4.4", desc: "Hand Dug Material Removed – Cold" },
  { id: "2.2.5.2", desc: "Equipment Fine Cleaning - Temperate" },
  { id: "2.2.5.3", desc: "Equipment Fine Cleaning – Cold" },
  { id: "2.2.7.2", desc: "FBE Coating Removal and Blasting" },
  { id: "2.2.7.4", desc: "Asbestos Containing Coating Removal" },
  { id: "2.2.7.5", desc: "Post Asbestos Abatement Blasting" },
  { id: "2.2.8.1.2", desc: "Site Support - Winter" },
  { id: "2.2.9.1", desc: "Sleeve Repair (first 1,000 weld – centimeters)" },
  { id: "2.2.9.2", desc: "Sleeve Repair (< 1,000 weld – centimeters)" },
  { id: "2.2.9.3", desc: "Clockspring" },
  { id: "2.2.9.4", desc: "Atlas Wrap" },
  { id: "2.2.9.5", desc: "Petrosleeve" },
  { id: "2.2.10.2", desc: "Coating Application (Epoxy) – Spray Applied" },
  { id: "2.2.11.1", desc: "Restoration Credit" },
...
digIds.forEach(val => {
 ...
 const classifications = [
  ...
  "Colton Amlin", "Cory Garnier", "Cory Pelkman (D&L)", "Craig Erickson", "Craig Welsman","Dalton Patrick", "Damon Keith", "Dan Therrien",
  "Daniel Pearo", "Danielle Nelson", "Darren Donley", "Darryl Meade (GPS)", "Dawson Chase", "David Guild", "Del James","Derek Seward",
 ...
 [
  ...
  { unit: "01-84", desc: "Chevrolet Silverado 3500 - crew truck" },
  ...
  { unit: "07-43R", desc: "Hitachi 245 Excavator" },
  { unit: "07-44R", desc: "Hitachi 245 Excavator" },
